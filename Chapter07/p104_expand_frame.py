# Frameを拡張したクラスとして、その初期化の中でウィジェットを生成する
# Frameのサブクラスを使った実装例
...
class MyFrame(tk.Frame):
    def __init__(self, master = None):  #  __initはクラスオブジェクトを作る際の初期化メソッド
        ...
        # 他のメソッドで参照する数値を表示するウィジェット、クラスオブジェクトの変数として作成、頭にself.がつく
